            ...
            <div class="table-responsive-sm">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @for ($n=0;$n<sizeof($items);$n++) <tr>
                            <td class="center">{{$n + 1}}</td>
                            <td class="left strong">{{$item=array_keys($items)[$n]}}</td>
                            @for ($i=0;$i<3;$i++) @if ($i !=1) <td class="center">{{formatrupiah($items[$item][$i])}}</td>
                                @else
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <a href="{{route('rm')}}" class="btn btn-block btn-danger">
                        <span class="icon"><i class="fa  fa-arrow-left"></i></span><span class="text" id="noprint"> Kembali</span></a>
                </div>
                <div class="col-sm-6">
